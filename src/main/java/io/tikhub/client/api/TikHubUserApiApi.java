...
public class TikHubUserApiApi {
   ...
   */
  public CompletableFuture<ResponseModel> calculatePriceApiV1TikhubUserCalculatePriceGet (String endpoint, Integer requestPerDay) throws ApiException {
    // verify the required parameter 'endpoint' is set
    if (endpoint == null) {
        return CompletableFuture.failedFuture(new ApiException(400, "Missing the required parameter 'endpoint' when calling calculatePriceApiV1TikhubUserCalculatePriceGet"));
    }
    ...
    localVarQueryParams.addAll(ApiClient.parameterToPairs("request_per_day", requestPerDay));
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "calculatePriceApiV1TikhubUserCalculatePriceGet call received non-success response",
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> calculatePriceApiV1TikhubUserCalculatePriceGet_0 (String endpoint, Integer requestPerDay) throws ApiException {
    // verify the required parameter 'endpoint' is set
    if (endpoint == null) {
        return CompletableFuture.failedFuture(new ApiException(400, "Missing the required parameter 'endpoint' when calling calculatePriceApiV1TikhubUserCalculatePriceGet_0"));
    }
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "calculatePriceApiV1TikhubUserCalculatePriceGet_0 call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> getAllEndpointsInfoApiV1TikhubUserGetAllEndpointsInfoGet () throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getAllEndpointsInfoApiV1TikhubUserGetAllEndpointsInfoGet call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> getAllEndpointsInfoApiV1TikhubUserGetAllEndpointsInfoGet_0 () throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getAllEndpointsInfoApiV1TikhubUserGetAllEndpointsInfoGet_0 call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> getEndpointInfoApiV1TikhubUserGetEndpointInfoGet (String endpoint) throws ApiException {
    // verify the required parameter 'endpoint' is set
    if (endpoint == null) {
        return CompletableFuture.failedFuture(new ApiException(400, "Missing the required parameter 'endpoint' when calling getEndpointInfoApiV1TikhubUserGetEndpointInfoGet"));
    }
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getEndpointInfoApiV1TikhubUserGetEndpointInfoGet call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> getEndpointInfoApiV1TikhubUserGetEndpointInfoGet_0 (String endpoint) throws ApiException {
    // verify the required parameter 'endpoint' is set
    if (endpoint == null) {
        return CompletableFuture.failedFuture(new ApiException(400, "Missing the required parameter 'endpoint' when calling getEndpointInfoApiV1TikhubUserGetEndpointInfoGet_0"));
    }
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getEndpointInfoApiV1TikhubUserGetEndpointInfoGet_0 call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> getTieredDiscountInfoApiV1TikhubUserGetTieredDiscountInfoGet () throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getTieredDiscountInfoApiV1TikhubUserGetTieredDiscountInfoGet call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> getTieredDiscountInfoApiV1TikhubUserGetTieredDiscountInfoGet_0 () throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getTieredDiscountInfoApiV1TikhubUserGetTieredDiscountInfoGet_0 call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> getUserDailyUsageApiV1TikhubUserGetUserDailyUsageGet () throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getUserDailyUsageApiV1TikhubUserGetUserDailyUsageGet call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ResponseModel> getUserDailyUsageApiV1TikhubUserGetUserDailyUsageGet_0 () throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getUserDailyUsageApiV1TikhubUserGetUserDailyUsageGet_0 call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<UserInfoResponseModel> getUserInfoApiV1TikhubUserGetUserInfoGet () throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getUserInfoApiV1TikhubUserGetUserInfoGet call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
               try {
                  return CompletableFuture.completedFuture(
                          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<UserInfoResponseModel>() {})
                  );
              } catch (IOException e) {
                  return CompletableFuture.failedFuture(new ApiException(e));
              }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<UserInfoResponseModel> getUserInfoApiV1TikhubUserGetUserInfoGet_0 () throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/json");
      ...
      return memberVarHttpClient.sendAsync(
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(new ApiException(localVarResponse.statusCode(),
                  "getUserInfoApiV1TikhubUserGetUserInfoGet_0 call received non-success response",
                  localVarResponse.headers(),
                  localVarResponse.body())
              );
          } else {
